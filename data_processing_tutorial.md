...
#RNA-seq
bamCoverage -b sample.sorted.bam -o sample.bw --normalizeUsing CPM

#paired-end
bamCoverage -b sample.sorted.bam -o sample.bw --normalizeUsing CPM --centerReads

#strand-specific RNA-seq
bamCoverage -b sample.sorted.bam -o sample.plus.bw  --filterRNAstrand forward
bamCoverage -b sample.sorted.bam -o sample.minus.bw --filterRNAstrand reverse
